...
class TestKMSEvaluateDI(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_require_vault_read_forwards_evaluate_to_policy(self):
        ...
        await self._kms_module._require_vault_read(mock_evaluate, user, vault_id=2)
    ...
    async def test_require_vault_write_forwards_evaluate_to_policy(self):
        ...
        await self._kms_module._require_vault_write(mock_evaluate, user, vault_id=2)
    ...
    async def test_require_vault_read_raises_403_when_policy_returns_false(self):
        ...
        with self.assertRaises(HTTPException) as ctx:
            await self._kms_module._require_vault_read(false_evaluate, user, vault_id=99)
    ...
    async def test_require_vault_write_raises_403_when_policy_returns_false(self):
        ...
        with self.assertRaises(HTTPException) as ctx:
            await self._kms_module._require_vault_write(false_evaluate, user, vault_id=99)
