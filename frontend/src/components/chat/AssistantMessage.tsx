...
import { useCanvasVisible } from "@/hooks/useCanvasCapabilities";
...
function CanvasEntryPoints({
  ...
  // Fail-closed boolean: false while the capabilities query loads or errors.
  const enabled = useCanvasVisible();
