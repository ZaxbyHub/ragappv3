...
| draft-compose-rewrite | pass | docs/eval/2026-09-meridian-qualification-evidence/requa5_mixed_compose.transcript.json — full draft lifecycle incl. mixed-source compose after the #652 streaming/timeout fix |
